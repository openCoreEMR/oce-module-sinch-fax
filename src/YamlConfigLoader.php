...
class YamlConfigLoader
{
     ...
     * @throws FaxConfigurationException if a file exists but is not readable or contains invalid YAML
     */
     ...
     * @throws FaxConfigurationException if file is not readable or contains invalid YAML
     */
    private function loadFile(string $filePath): array
    {
        if (!is_readable($filePath)) {
            throw new FaxConfigurationException(
